      ...
      <div class="sub-cards-grid">
        ...
        <div class="glass sub-card">
          <div class="sub-card-details">
            ...
            <div class="detail-row">
              <span>🔄 Returns</span>
              <span>${loc.return_completed || 0} / ${loc.returns || 0}</span>
            </div>
            <div class="detail-row">
              <span>⚠️ No Show</span>
...
async function forceSync() {
  ...
  try {
    // Insertar comando sync_now en Supabase
    const { data, error } = await sbClient
      .from('comandos_bot')
    ...
    console.log('Comando insertado correctamente:', data);
    const comandoId = data.id;
    
    // Suscribirse a los cambios en ese registro
